      ...
      <div class="card-header card-header-primary">
        <div class="row container">
          ...
          <div class="col-md-11">
            ...
            <p class="card-category"> Berikut form untuk membuat warna baru</p>
          </div>
        </div>
      </div>
      <div class="card-body">
        <form action="{{ route('admin.warna.store') }}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="form-group">
            <input id="color" type="text" name="hex" class="form-control">
          </div>
          <div align="right">
